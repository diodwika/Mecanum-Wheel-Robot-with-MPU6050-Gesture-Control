...
void directionMotor(float pitch, float roll) {
  ...
  analogWrite(motor1EnablePin, abs(motorSpeedScaled));
  analogWrite(motor2EnablePin, abs(motorSpeedScaled));
  analogWrite(motor3EnablePin, abs(motorSpeedScaled));
  analogWrite(motor4EnablePin, abs(motorSpeedScaled));
}
